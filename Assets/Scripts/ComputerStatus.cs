...
public class ComputerStatus : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            cpuStatusTextbox.text = "QOSYLMAĞAN";
        ...
        {
            gpuStatusTextbox.text = "QOSYLMAĞAN";
        ...
        if (HasMotherboard)
        {
            moboStatusTextbox.text = "Qosyldy";
        ...
        {
            moboStatusTextbox.text = "QOSYLMAĞAN";
        ...
        {
            ramStatusTextbox.text = "QOSYLMAĞAN";
        ...
        {
            fanStatusTextbox.text = "QOSYLMAĞAN";
